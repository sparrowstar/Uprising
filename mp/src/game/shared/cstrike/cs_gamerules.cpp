...
ConVar cl_autohelp(
	...
	*/
	...
	int CCSGameRules::SelectDefaultTeam( bool ignoreBots /*= false*/ )
	{
		...
		if ( ignoreBots )
		{
			numTerrorists = UTIL_HumansOnTeam( TEAM_TERRORIST, true );
			numCTs = UTIL_HumansOnTeam( TEAM_CT, true );
		}
...
CAmmoDef* GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		//Half-Life 2 ammo type
		ammoDef.AddAmmoType("slam", DMG_BURN, TRACER_NONE, 0, 0, 5, 0, 0);
		...
		ammoDef.AddAmmoType("SniperRound", DMG_BULLET | DMG_SNIPER, TRACER_NONE, "sk_plr_dmg_sniper_round", "sk_npc_dmg_sniper_round", "sk_max_sniper_round", BULLET_IMPULSE(650, 6000), 0);
		ammoDef.AddAmmoType("SniperPenetratedRound", DMG_BULLET | DMG_SNIPER, TRACER_NONE, "sk_dmg_sniper_penetrate_plr", "sk_dmg_sniper_penetrate_npc", "sk_max_sniper_round", BULLET_IMPULSE(150, 6000), 0);
