	...
	case PLAYERANIMEVENT_RELOAD:
		{
			...
			if ( pWeapon && pWeapon->GetWpnData().m_WeaponType != WEAPONTYPE_SHOTGUN )
			{
...
int CCSPlayerAnimState::CalcReloadLayerSequence( PlayerAnimEvent_t event )
{
	...
	if ( pWeapon->GetWpnData().m_WeaponType == WEAPONTYPE_PISTOL )
	{
...
const char* CCSPlayerAnimState::GetWeaponSuffix()
{
	...
	const char *pSuffix = pWeapon->GetWpnData().m_szAnimExtension;
