...
CLogicPlayerProxy *CCSPlayer::GetPlayerProxy(void)
{
...
void CCSPlayer::FirePlayerProxyOutput(const char *pszOutputName, variant_t variant, CBaseEntity *pActivator, CBaseEntity *pCaller)
{
...
//	CCSPlayer *pPlayer = dynamic_cast<CCSPlayer*>(m_hPlayer.Get());
...
void CCSPlayer::Precache()
{
	...
	PrecacheModel("models/player/ct_sas.mdl");
	PrecacheModel("models/player/ct_urban.mdl");
	PrecacheModel("models/player/ct_gign.mdl");
	PrecacheModel("models/player/ct_gsg9.mdl");
	PrecacheModel("models/player/t_leet.mdl");
	PrecacheModel("models/player/t_arctic.mdl");
	PrecacheModel("models/player/t_phoenix.mdl");
	PrecacheModel("models/player/t_guerilla.mdl");
...
//-----------------------------------------------------------------------------
Vector CCSPlayer::GetAttackSpread(CBaseCombatWeapon *pWeapon, CBaseEntity *pTarget)
{
	if (pWeapon)
...
//-----------------------------------------------------------------------------
void CCSPlayer::CombineBallSocketed(CPropCombineBall *pCombineBall)
{
#ifdef HL2_EPISODIC
...
// 
//-----------------------------------------------------------------------------
void CCSPlayer::MissedAR2AltFire()
{
	if (GetPlayerProxy() != NULL)
	{
...
//-----------------------------------------------------------------------------
bool CCSPlayer::Weapon_Lower(void)
{
	VPROF("CCSPlayer::Weapon_Lower");
	// Already lowered?
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CCSPlayer::Weapon_Ready(void)
{
	VPROF("CCSPlayer::Weapon_Ready");
...
ConVar uprising_csplr_debug("uprising_csplr_debug", "0", FCVAR_CHEAT, "If 1, then Combine (CTs) will spawn with USPs and Rebels (Terrorists) with Glocks. Both get knifes.");
...
void CCSPlayer::GiveDefaultItems()
{
	...
	if (uprising_csplr_debug.GetBool())
	{
	...
	switch( iImpulse )
	{
		case 101:
		{
			if( sv_cheats->GetBool() )
			{
				...
				GiveAmmo( 300, BULLET_PLAYER_50AE );
				GiveAmmo( 300, BULLET_PLAYER_762MM );
				GiveAmmo( 300, BULLET_PLAYER_338MAG );
				GiveAmmo( 300, BULLET_PLAYER_556MM );
				GiveAmmo( 300, BULLET_PLAYER_556MM_BOX );
				GiveAmmo( 300, BULLET_PLAYER_9MM );
				GiveAmmo( 300, BULLET_PLAYER_BUCKSHOT );
				GiveAmmo( 300, BULLET_PLAYER_45ACP );
				GiveAmmo( 300, BULLET_PLAYER_357SIG );
				GiveAmmo( 300, BULLET_PLAYER_57MM );

				GiveAmmo( 300,	"Pistol");
				GiveAmmo( 300,	"AR2");
				GiveAmmo( 300,	"AR2AltFire");
				GiveAmmo( 300,	"SMG1");
				GiveAmmo( 300,	"Buckshot");
				GiveAmmo( 300,	"smg1_grenade");
				GiveAmmo( 300,	"rpg_round");
				GiveAmmo( 300,	"grenade");
				GiveAmmo( 300,	"357" );
				GiveAmmo( 300,	"XBowBolt" );
				GiveAmmo( 300,	"slam" );
				GiveAmmo( 300,	"Hopwire" );
